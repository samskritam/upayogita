...
object अक्षर{
  ...
  val ओ =   अक्षर("ओ",(अोष्ठ्य,अर्ध),अल्पप्राण, ह्रस्व, संकुचित_दीर्घ,  घोष ,  अनुनासिक_न, ऊष्म_न,Some("ो"))
  val औ =   अक्षर.सन्युक्त("औ",अ,ऊ,Some("ौ"))
  ...
  val अँ =   अक्षर("अँ",List(List((अस्पर्ष,शून्य)),List((कण्ठ्य,पूर्ण))),अल्पप्राण, ह्रस्व, संकुचित_न,  घोष ,  अनुनासिक, ऊष्म_न,Some("ँ"))
  ...
  val  ॠ =   अक्षर.सन्युक्त("ॠ", र्  ,ई,Some(" ॄ"))
